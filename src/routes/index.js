...
router.get('/apps/:appName', async (ctx) => {
...
router.get('/api/apps/:appName/logs/:logType', async (ctx) => {
...
router.post('/api/apps/:appName/reload', async (ctx) => {
    try{
...
router.post('/api/apps/:appName/restart', async (ctx) => {
    try{
        let { appName } = ctx.params
...
router.post('/api/apps/:appName/stop', async (ctx) => {
    try{
        let { appName } = ctx.params
